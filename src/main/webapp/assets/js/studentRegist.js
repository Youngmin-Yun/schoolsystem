$(function(){
    ...
    $("#join").click(function(){
        ...
        let data = {
            ...
            res_address:user_address,
            res_birth:user_birth,
            res_phone: user_phone,
            res_phone2: user_phone2
            }
        $.ajax({
            type:"post",
            url:"/regist/api/student",
    ...
    $("#chk_id").click(function(){
        ...
        $.ajax({
            type:"get",
            url:"/regist/api/studentid?id="+user_id,
            success:function(r){
    ...
    $("#chk_email").click(function(){
        ...
        $.ajax({
            type:"get",
            url:"/regist/api/studentemail?email="+user_email,
            success:function(r){
                alert(r.message);
                emailcheck = !r.status;
            }
